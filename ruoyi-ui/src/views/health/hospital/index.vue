<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['health:hospital:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['health:hospital:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['health:hospital:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['health:hospital:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="hospitalList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="大众对医院的热度" align="center" prop="herdTowardsEnthusiasm" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="大众对医院的热度" prop="herdTowardsEnthusiasm">
          <el-input v-model="form.herdTowardsEnthusiasm" placeholder="请输入大众对医院的热度" />
        </el-form-item>
      </el-form>
...
<script>
import { listHospital, getHospital, delHospital, addHospital, updateHospital } from "@/api/health/hospital";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('health/hospital/export', {
        ...this.queryParams
